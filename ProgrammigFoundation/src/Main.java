...
public class Main {
	...
	public static void main(String[] args) {
		...
		//
		System.out.println("Enter the options based on choice " + "1. Add \n 2. sub  \n 3. div \n 4. mul \n 5. exit");
		...
		// scanner : reference : it will refer the object.
		// it will help us to use data / methods from object(which you will get it from
		// the RHS).
		...
		while (true) {
			...
			case 4: {
				System.out.println("Divison case");
				System.out.println("Please enter two numbers");
				float number1 = scanner.nextFloat();
				float number2 = scanner.nextFloat();
			...
			System.exit(0);//To end the execution of the program	
			break;
			default: {
